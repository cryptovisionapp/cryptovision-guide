...
![](../../assets/img/transaction-window-ja-1.png)
...
![](../../assets/img/transaction-window-ja-4.png)
...
![](../../assets/img/transaction-window-ja-10.png)

各取引分類の意味については、[取引分類の意味を理解する](./transaction-journal.md)　で説明しています。
